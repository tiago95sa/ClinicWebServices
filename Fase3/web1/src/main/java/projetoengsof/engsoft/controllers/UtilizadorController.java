...
public class UtilizadorController  {
    ...
    @RequestMapping(value="/mostrar/{id}",method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_VALUE)
    public @ResponseBody
    Set<Consulta> getConsultasUtilizador(@PathVariable("id") Long id){

        return utilizadorService.getConsultasUtilizador(id);
    }
